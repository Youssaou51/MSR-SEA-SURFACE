function [Nrcs_Mdl_VV, Nrcs_Mdl_HH, A_mono, B1mono_VV, Ans0, Ans2] = f_Nrcs_3dMono_StatisticSea_SSA1_Fetch_v1 (Th_i_d, phi_rel_d, er2, u_10, fetch_m, k0, r_max, aff, n_r) 

%--------------------------------------------------------------------------
% FUNCTION : f_Nrcs_3dMono_StatisticSea_SSA1_Fetch_v1 
%--------------------------------------------------------------------------
...
% functions W0_r & W2_r (=1), or also the integrands (~=0) [scalar] 
% n_r   : Number of samping points for radial distance calculation (-) [scalar] 
%--------------------------------------------------------------------------
% Output variables:
...
r_max_fu10 = r_max * (f0_Hz/f_Hz)^0.5 * (u0_10/u_10) 
...
%
Nom = [ 'DataSeaSurf2d/SeaSurf_2dCorrFcts_omg' num2str(omg) '_ud' num2str(u_10) 'ms' ] ; Nom(Nom=='.') = '-' ; Nom = [ Nom '.mat' ] ;
...
%     n_r = 10 * r_maxCorr ; 
% end
% Nom = [ 'DataSeaSurf2d/SeaSurf_2dCorrFcts_omg' num2str(omg,'%.2f') '_ud' num2str(u_10,'%04.1f') 'ms_rmax' num2str(r_maxCorr,'%04i') '_nr' num2str(n_r,'%05i') ] ; 
% Nom(Nom=='.') = '-' ; Nom = [ Nom '.mat' ] ; 
% C = load(Nom, 'R','W0_r','W2_r','u_10','omg') ; % 'R', 'W0_r', 'W2_r', 'K', 'W0_k', 'W2_k', 'u_10', 'omg', 'n_r', 'r_min', 'r_max', 'n_k', 'k_min', 'k_max', 'g' 
...
%
z0 = 3e-3 ; 
u_12 = log(12.5/z0)/log(10/z0) * u_10 ; % d'après [2012_Wang_TGRS,eq36] 
sig2_sx_int = 3.16e-3 * u_12 ; % [Pinel_Book,eq1.83][Cox_1954_JOSA,p.847] 
sig2_sy_int = 1.92e-3 * u_12 + 3e-3 ; % [Pinel_Book,eq1.84][Cox_1954_JOSA,p.847] 
