function [Nrcs_Mdl_VV, Nrcs_Mdl_HH, Nrcs_Mdl_VH] = f_Nrcs_3dMono_EmpExpSea_Lband_Meissner (Th_i_d, u10_ms, windDir_d) 

%--------------------------------------------------------------------------
% FUNCTION: f_Nrcs_3dMono_EmpExpSea_Lband_Meissner
%--------------------------------------------------------------------------
...
thR2_d = 38.44 ; % Incidence angle for radiometer/scatterometer 1 (deg.) 
thR3_d = 46.29 ; % Incidence angle for radiometer/scatterometer 1 (deg.) 
