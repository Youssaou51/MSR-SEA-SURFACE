function [Uz_ms, Uz_NSA_ms, U_f, U_f_NSA] = f_Sea_WindSpeedHeightConversion (U10_ms, z_m, fetch_m) 
...
%
kk = 0.40 ;
Z0 = 3.7e-5 * U10_ms.^2/g .* (U10_ms./Cp).^0.9 ; % [1997_Elfouhaily_JGR,eq.66] 
Z0(U10_ms==0) = 0 ; 
U_f = kk ./ log(10./Z0) .* U10_ms ; % [1997_Elfouhaily_JGR,eq.60]
%
...
U_f_NSA = sqrt( C_d10N ) .* U10_ms ; % C. Bourlier -> [1997_Elfouhaily_JGR,eq.61]
