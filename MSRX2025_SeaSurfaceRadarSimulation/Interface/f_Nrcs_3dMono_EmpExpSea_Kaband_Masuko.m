function [Nrcs_Mdl_VV, Nrcs_Mdl_HH] = f_Nrcs_3dMono_EmpExpSea_Kaband_Masuko (Th_i_d, u19_ms, windDir_d) 

%--------------------------------------------------------------------------
% FUNCTION : f_Nrcs_3dMono_EmpExpSea_Kaband_Masuko
%--------------------------------------------------------------------------
...
% in VV and HH polarizations and in Ka band (34.43 GHz), with respect to the empirical 
...
g =  1.455 ; %  1.787 @ 10.00 GHz,  1.455 @ 34.43 GHz
h = -0.857 ; % -0.569 @ 10.00 GHz, -0.857 @ 34.43 GHz
